...
- Update GitHub App authentication to use installation tokens. (#29)

### Added

- Support GitHub App authentication for PR creation with PAT fallback.
...
- Refactor GitHub authentication logic and remove magic numbers.

### Docs

- Update changelog for version 0.0.6. (#29)
